...
def precompute_token_lengths(model_config) -> torch.Tensor:
    ...
    token_lengths[tokenizer.eos_token_id] = envs.VLLM_EOS_TOKEN_LENGTH
...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def __init__(
        ...
        self.sampler = Sampler(token_lengths_gpu=token_lengths_gpu, logprobs_mode=self.model_config.logprobs_mode)
